...
public class UserTests2 {
	...
	public void testPostUser()
	{
		...
		Response res1 = UserEndpoints2.createUser(UPayload);
		res1.then().log().all();
	...
	public void testGetUserByName()
	{
		...
		Response res2 = UserEndpoints2.readUser(this.UPayload.getUsername());
		res2.then().log().all();
	...
	public void testUpdateUserByName()
	{
		...
		Response res3 = UserEndpoints2.updateUser(UPayload, this.UPayload.getUsername());
		res3.then().log().all();
		
		Assert.assertEquals(res3.getStatusCode(), 200);
		
		//Checking the data after updating
		Response resAfterUpdate = UserEndpoints2.readUser(this.UPayload.getUsername());
	...
	public void testDeleteUserByName()
	{
		...
		Response res4 = UserEndpoints2.deleteUser(this.UPayload.getUsername());
